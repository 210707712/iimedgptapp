<template>
  <div class="home">
    ...
    <div class="home-right">
      <div class="right-version">
        <div class="llm-chat-demo">
          <span class="chat-demo">基于IIMedGPT的脓毒症急性胃肠功能障碍中西医结合诊治方法</span>
      ...
      <div class="right-input" @keyup.enter="handleSearch">
        <!-- 输入框 -->
        <el-input v-model="queryKeyword" placeholder="给中西医结合诊治大模型发送消息" class="input"></el-input>
        <!-- 查询按钮 -->
    ...
    <el-button type="text" class="close-button" @click="toggleSettings">关闭</el-button>
      ...
      <div class="sec-notice">中西医结合诊治大模型平台，生成内容仅供学习，具体病情请询问医师。</div>
    </div>
  </div>
</template>
