...
def main():
    ...
    arguments = Arguments(
        ...
        generation_model="/home/user/gptdata/fcg/model/Qwen/Qwen2___5-14B-Instruct",
    ...
    assistant = MemoryScopeAgent("IIMedGPT", arguments=arguments)

    # Create the agent that represents the user in the conversation.
    user_proxy = UserProxyAgent("用户", code_execution_config=False)
